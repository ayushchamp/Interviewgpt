...
class QuestionCreationChain(LLMChain):
    ...
    def from_llm(cls, llm: BaseLLM, position_description: str, applicant_resume: str, verbose: bool = True) -> LLMChain:
        ...
        question_creation_template = (
            ...
            " Return the consolidated single list of questions as a JSON-compliant list(do not add backticks) i.e. [{{\"question_id\": 1, \"question_title\": \"quesiton 1\"}}, {{\"question_id\": 2, \"question_title\": \"quesiton 2\"}}, {{\"question_id\": 3, \"question_title\": \"quesiton 3\"}} etc]"
    ...
    def get_new_questions(self, evaluation: str, answer: str, question: str, question_list: List[str], previous_questions: List[str]) -> List[Dict]:
        ...
        print("AAAAAAAAAAAAAA", cleaned_response)
...
class QuestionPrioritizationChain(LLMChain):
    ...
    def from_llm(cls, llm: BaseLLM, position_description: str, applicant_resume: str, verbose: bool = True) -> LLMChain:
        ...
        question_prioritization_template = (
            ...
            " Return the reprioritized questions compulosry as a JSON-compliant list(do not add backticks) i.e. [{{\"question_id\": 1, \"question_title\": \"quesiton 1\"}}, {{\"question_id\": 2, \"question_title\": \"quesiton 2\"}}, {{\"question_id\": 3, \"question_title\": \"quesiton 3\"}} etc]."
    ...
    def prioritize_questions(self, this_question_id: int, question_list: List[Dict]) -> List[Dict]:
        ...
        cleaned_response = response.replace("```json\n[", "[").replace("\n]\n```", "]").strip()
        print("Res::",cleaned_response)
        prioritized_question_list = json.loads(cleaned_response)
        # Adjust question IDs
